...
public class SnippetsTest {
    public final Properties snippets;
    ...
    public SnippetsTest() {
        ...
        try {
            String sb = "LOCAL_LOAD_ARG_1=clocal$index.i = (jint) $arg;\n" +
                    ...
                    "BALOAD= cstack$stackindexm2.i = (jint) baload(env, (jarray) cstack$stackindexm2.l, cstack$stackindexm1.i);\n" +
                    ...
                    "TRYCATCH_VOID=if ((*env)->ExceptionCheck(env)) { (*env)->ExceptionDescribe(env); (*env)->ExceptionClear(env); }\n" +
                    "TRYCATCH_VOID2=if ((*env)->ExceptionCheck(env)) { (*env)->ExceptionDescribe(env); (*env)->ExceptionClear(env); }\n" +
    ...
    public String getSnippet(final String key, final Map<String, String> tokens) {
        ...
        //    System.out.println("                                                                                                                                ");
        //    tokens.forEach((k, v) -> System.out.printf("%s %s\n", k,v));
        //   System.out.printf("            %s \n %s \n %s \n %s \n",  tokens, value, key, Util.dynamicRawFormat(value, result));
