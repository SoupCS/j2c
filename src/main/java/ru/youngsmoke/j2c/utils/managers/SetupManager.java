package ru.youngsmoke.j2c.utils.managers;


import com.google.gson.Gson;
import ru.youngsmoke.j2c.utils.helpers.ProcessHelper;
import ru.youngsmoke.j2c.utils.FileUtils;
import ru.youngsmoke.j2c.utils.Zipper;
...
public class SetupManager {
    ...
    public static void downloadZigCompiler(final String fileName, final String dirName) {
        ...
        try {
            ...
            System.out.println("Скачивание компилятора");
            ...
            System.out.println("Скачивание закончено, распаковка.");
            unzipFile(currentDir, fileName, currentDir);
            deleteFile(currentDir, fileName + ".temp");
            deleteFile(currentDir, fileName);
            System.out.println("Установка компилятора закончена успешно!");
            if (!isWindows()) {
